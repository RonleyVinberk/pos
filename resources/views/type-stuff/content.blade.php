        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="background: #e9ecef !important;">
                    ...
                    <li class="breadcrumb-item active">Types Stuff</li>
                </ol>
            </nav>
            {{-- end breadcrumb --}}
                ...
                <div class="x_content">
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                            <table id="datatable-types_stuff" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <a href="{{route('types_stuff.show', $item->id)}}" role="button" class="btn btn-sm btn-info">View</a>
                                            <a href="{{route('types_stuff.edit', $item->id)}}" role="button" class="btn btn-sm btn-primary">Edit</a>
                                            {{Form::open(['route' => ['types_stuff.destroy', $item->id], 'class' => 'form-horizontal', 'style' => 'display: -webkit-inline-box'])}}
                                            {{method_field('DELETE')}}
                                            {{Form::button('Delete', ['type' => 'submit', 'class' => 'btn btn-sm btn-danger', 'style' => 'position: relative; top: -10px;', 'onclick' => 'return confirm("You sure to delete this data?")'])}}
                                            {{Form::close()}}
                                        </td>
                                    </tr>
                                    @endforeach
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                            {{Form::open(['route' => 'types_stuff.store', 'class' => 'form-horizontal form-label-left', 'data-parsley-validate'])}}
